...
1. computeOverPredict(predictions, full data set)
    - returns the ratio of over-guesses
    - to the total number of predictions we got wrong
    
2. rebalanceSample(x, y, desired sample size)
    - extracts a balanced sample of x and y
    
3. plotLearningCurve(training sizes, training scores, test scores, model name)
    - generates a plot of the learning curve
    
4. plotValidationCurve(x-axis values, training scores, testing scores,
                       model name, x-label)
